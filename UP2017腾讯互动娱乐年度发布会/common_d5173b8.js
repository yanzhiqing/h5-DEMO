...
function adjustSize() {
	$("html").css({
		fontSize: $(window).width() / 1920 * 100
	})
}
function pop(e, t, n) {
	isnowpop = !0,
	e = e || "//game.gtimg.cn/images/up/act/a20170301pre/images/three/banner0.jpg";
	var i = $("#pop");
	isnowpop = !0,
	i.addClass("show"),
	n && i.addClass("tall"),
...
function initFullpage() {
	$("#fullpage").fullpage({
		...
		afterLoad: function(e, t) {
			tryPgvSendClick({
				hottag: "a20170301pre.page.page" + e
			}),
...
function(e, t, n, i, o) {
	...
	e.fn.fullpage = function(r) {
		...
		function at(t, n) {
			"undefined" != typeof n ? (n = n.replace(/ /g, "").split(","), e.each(n,
			function(e, n) {
				ii(t, n, "m")
			})) : t ? (st(!0), Gn()) : (st(!1), Kn())
		}
		...
		function lt() {
			var t = e(b).prev(k);
			t.length || !r.loopTop && !r.continuousVertical || (t = e(k).last()),
			t.length && Ut(t, null, !0)
		}
		function ct() {
			var t = e(b).next(k);
			t.length || !r.loopBottom && !r.continuousVertical || (t = e(k).first()),
			t.length && Ut(t, null, !1)
		}
		function ut(e, t) {
			V(0, "internal"),
			dt(e, t),
			V(Bi.scrollingSpeed, "internal")
		}
		function dt(e, t) {
			var n = jn(e);
		...
		function pt(t) {
			if (!Ci.hasClass(d)) {
				...
				e(k).each(function() {
					var t = e(this).find(z),
					n = e(this).find(O);
					r.verticalCentered && e(this).find(L).css("height", Bn(e(this)) + "px"),
					e(this).css("height", ki + "px"),
					r.scrollOverflow && (n.length ? n.each(function() {
						En(e(this))
					}) : En(e(this))),
					n.length > 1 && Cn(t, t.find(j))
				});
				var n = e(b),
				i = n.index(k);
				i && ut(i + 1),
				bi = !1,
				e.isFunction(r.afterResize) && t && r.afterResize.call(Ci),
		...
		function mt() {
			r.css3 && (r.css3 = Yn()),
			r.scrollBar = r.scrollBar || r.hybrid,
			yt(),
			Ct(),
			at(!0),
			l(r.autoScrolling, "internal"),
			Fn(),
			Nn(),
			"complete" === n.readyState && an(),
			tt.on("load", an)
		}
		function vt() {
			tt.on("scroll", Et).on("hashchange", rn).blur(pn).resize(wn),
			nt.keydown(ln).keyup(un).on("click touchstart", D + " a", gn).on("click touchstart", N, mn).on("click", I, cn),
			e(k).on("click touchstart", W, hn),
			r.normalScrollElements && (nt.on("mouseenter", r.normalScrollElements,
			function() {
				st(!1)
			}), nt.on("mouseleave", r.normalScrollElements,
			function() {
				st(!0)
			}))
		}
		function yt() {
			...
			r.navigationTooltips.length || (r.navigationTooltips = t.filter("[data-tooltip]").map(function() {
		...
		function Ct() {
			...
			e(k).each(function(t) {
				...
				bt(n, t),
				St(n, t),
				o > 0 ? kt(n, i, o) : r.verticalCentered && An(n)
			}),
			r.fixedElements && r.css3 && e(r.fixedElements).appendTo(ui),
			r.navigation && Lt(),
			Tt(),
			r.scrollOverflow ? ("complete" === n.readyState && xt(), tt.on("load", xt)) : $t()
		}
		function kt(t, n, i) {
			var o = 100 * i,
			s = 100 / i;
			n.wrapAll('<div class="' + H + '" />'),
			n.parent().wrap('<div class="' + P + '" />'),
			t.find(R).css("width", o + "%"),
			i > 1 && (r.controlArrows && Ft(t), r.slidesNavigation && Rn(t, i)),
			n.each(function() {
				e(this).css("width", s + "%"),
				r.verticalCentered && An(e(this))
			});
			var a = t.find(j);
			a.length && (0 !== e(b).index(k) || 0 === e(b).index(k) && 0 !== a.index()) ? ei(a, "internal") : n.eq(0).addClass(p)
		}
		function bt(t, n) {
			n || 0 !== e(b).length || t.addClass(p),
			gi = e(b),
			t.css("height", ki + "px"),
			r.paddingTop && t.css("padding-top", r.paddingTop),
			r.paddingBottom && t.css("padding-bottom", r.paddingBottom),
			"undefined" != typeof r.sectionsColor[n] && t.css("background-color", r.sectionsColor[n]),
			"undefined" != typeof r.anchors[n] && t.attr("data-anchor", r.anchors[n])
		}
		function St(t, n) {
			"undefined" != typeof r.anchors[n] && t.hasClass(p) && Dn(r.anchors[n], n),
			r.menu && r.css3 && e(r.menu).closest(a).length && e(r.menu).appendTo(ui)
		}
		function wt() {
			Ci.find(r.sectionSelector).addClass(C),
			Ci.find(r.slideSelector).addClass(B)
		}
		function Ft(e) {
			e.find(z).after('<div class="' + X + '"></div><div class="' + Z + '"></div>'),
			"#fff" != r.controlArrowColor && (e.find(et).css("border-color", "transparent transparent transparent " + r.controlArrowColor), e.find(G).css("border-color", "transparent " + r.controlArrowColor + " transparent transparent")),
			r.loopHorizontal || e.find(G).hide()
		}
		function Lt() {
			...
			for (var n = 0; n < e(k).length; n++) {
				...
				s = r.navigationTooltips[n];
				"undefined" != typeof s && "" !== s && (o += '<div class="' + $ + " " + r.navigationPosition + '">' + s + "</div>"),
				o += "</li>",
				t.find("ul").append(o)
			}
			e(D).css("margin-top", "-" + e(D).height() / 2 + "px"),
			e(D).find("li").eq(e(b).index(k)).find("a").addClass(p)
		}
		function xt() {
			e(k).each(function() {
				var t = e(this).find(O);
		...
		function $t() {
			var t = e(b);
			t.addClass(m),
			r.scrollOverflowHandler.afterRender && r.scrollOverflowHandler.afterRender(t),
			en(t),
			tn(t),
			r.scrollOverflowHandler.afterLoad(),
			It() && e.isFunction(r.afterLoad) && r.afterLoad.call(t, t.data("anchor"), t.index(k) + 1),
			e.isFunction(r.afterRender) && r.afterRender.call(Ci)
		}
		function It() {
			var e = t.location.hash.replace("#", "").split("/"),
			n = jn(decodeURIComponent(e[0]));
		...
		function Et() {
			...
			if (!r.autoScrolling || r.scrollBar) {
				...
				s = 0,
				a = i + tt.height() / 2,
				l = ui.height() - tt.height() === i,
				c = n.querySelectorAll(k);
				if (l) s = c.length - 1;
				else if (i) for (var u = 0; u < c.length; ++u) {
					var d = c[u];
					d.offsetTop <= a && (s = u)
				} else s = 0;
				if (Bt(o) && (e(b).hasClass(m) || e(b).addClass(m).siblings().removeClass(m)), t = e(c).eq(s), !t.hasClass(p)) {
					...
					S = t.index(k) + 1,
					w = t.find(j);
					w.length && (h = w.data("anchor"), f = w.index()),
					wi && (t.addClass(p).siblings().removeClass(p), e.isFunction(r.onLeave) && r.onLeave.call(g, v, S, y), e.isFunction(r.afterLoad) && r.afterLoad.call(t, C, S), on(g), en(t), tn(t), Dn(C, S - 1), r.anchors.length && (fi = C), Qn(f, h, C, S)),
					clearTimeout(Di),
		...
		function Pt(e) {
			var t = e.originalEvent; ! Ht(e.target) && r.autoScrolling && Rt(t) && e.preventDefault()
		}
		function zt(t) {
			var n = t.originalEvent,
			o = e(n.target).closest(k);
			if (!Ht(t.target) && Rt(n)) {
				r.autoScrolling && t.preventDefault();
				var s = r.scrollOverflowHandler.scrollable(o),
				a = Zn(n);
				Hi = a.y,
				Ri = a.x,
				o.find(z).length && i.abs(zi - Ri) > i.abs(Pi - Hi) ? !mi && i.abs(zi - Ri) > tt.outerWidth() / 100 * r.touchSensitivity && (zi > Ri ? Li.m.right && ft(o) : Li.m.left && ht(o)) : r.autoScrolling && wi && i.abs(Pi - Hi) > tt.height() / 100 * r.touchSensitivity && (Pi > Hi ? jt("down", s) : Hi > Pi && jt("up", s))
			}
		}
		function Ht(t, n) {
			n = n || 0;
		...
		function qt(e, t) {
			for (var n = 0,
			o = e.slice(i.max(e.length - t, 1)), s = 0; s < o.length; s++) n += o[s];
			return i.ceil(n / t)
		}
		function _t(n) {
			...
			if (r.autoScrolling && !pi && !s) {
				...
				Fi.length > 149 && Fi.shift(),
				Fi.push(i.abs(a)),
				r.scrollBar && (n.preventDefault ? n.preventDefault() : n.returnValue = !1);
				var d = e(b),
				f = r.scrollOverflowHandler.scrollable(d),
				h = o - Qi;
				if (Qi = o, h > 200 && (Fi = []), wi) {
					var p = qt(Fi, 10),
					g = qt(Fi, 70),
		...
		function Wt(e) {
			...
			n = t.top,
			i = t.top > qi,
			o = n - ki + e.outerHeight(),
			s = r.bigSectionsDestination;
			return e.outerHeight() > ki ? (!i && !s || "bottom" === s) && (n = o) : (i || bi && e.is(":last-child")) && (n = o),
			qi = n,
			n
		}
		function Ut(t, n, i) {
		...
		function Vt(t) {
			if (r.css3 && r.autoScrolling && !r.scrollBar) {
				...
				On(n, !0),
				r.scrollingSpeed ? (clearTimeout(Ti), Ti = setTimeout(function() {
					Jt(t)
				},
		...
		function Gt(t) {
			return t.isMovementUp ? e(b).before(t.activeSection.nextAll(k)) : e(b).after(t.activeSection.prevAll(k).get().reverse()),
			ti(e(b).position().top),
			Yt(),
			t.wrapAroundElements = t.activeSection,
			t.dtop = t.element.position().top,
			t.yMovement = $n(t.element),
			t
		}
		function Kt(t) {
		...
		function Jt(t) {
			Kt(t),
			e.isFunction(r.afterLoad) && !t.localIsResizing && r.afterLoad.call(t.element, t.anchorLink, t.sectionIndex + 1),
			r.scrollOverflowHandler.afterLoad(),
			t.localIsResizing || tn(t.element),
			t.element.addClass(m).siblings().removeClass(m),
			wi = !0,
		...
		function ln(t) {
			...
			if (!n.is("textarea") && !n.is("input") && !n.is("select") && "true" !== n.attr("contentEditable") && "" !== n.attr("contentEditable") && r.keyboardScrolling && r.autoScrolling) {
				var i = t.which,
				o = [40, 38, 32, 33, 34];
				e.inArray(i, o) > -1 && t.preventDefault(),
				pi = t.ctrlKey,
		...
		function yn(e) {
			wi && (e.pageY < _i && Li.m.up ? lt() : e.pageY > _i && Li.m.down && ct()),
			_i = e.pageY
		}
		function Cn(t, n, i) {
			var o = t.closest(k),
			...
			return s.xMovement = In(s.prevSlideIndex, s.slideIndex),
			s.localIsResizing || (wi = !1),
			r.onSlideLeave && !s.localIsResizing && "none" !== s.xMovement && e.isFunction(r.onSlideLeave) && r.onSlideLeave.call(s.prevSlide, s.anchorLink, s.sectionIndex + 1, s.prevSlideIndex, s.xMovement, s.slideIndex) === !1 ? void(mi = !1) : (n.addClass(p).siblings().removeClass(p), s.localIsResizing || (on(s.prevSlide), en(n)), !r.loopHorizontal && r.controlArrows && (o.find(G).toggle(0 !== s.slideIndex), o.find(et).toggle(!n.is(":last-child"))), o.hasClass(p) && !s.localIsResizing && Qn(s.slideIndex, s.slideAnchor, s.anchorLink, s.sectionIndex), void bn(t, s, !0))
		}
		function kn(t) {
			Sn(t.slidesNav, t.slideIndex),
			t.localIsResizing || (e.isFunction(r.afterSlideLoad) && r.afterSlideLoad.call(t.destiny, t.anchorLink, t.sectionIndex + 1, t.slideAnchor, t.slideIndex), wi = !0, tn(t.destiny)),
			mi = !1
		}
		function bn(e, t, n) {
			var o = t.destinyPos;
		...
		function Sn(e, t) {
			e.find(g).removeClass(p),
			e.find("li").eq(t).find("a").addClass(p)
		}
		function wn() {
			if (Fn(), vi) {
		...
		function En(e) {
			if (!e.hasClass("fp-noscroll")) {
				...
				t > a ? s.length ? n.update(e, a) : (r.verticalCentered ? e.find(L).wrapInner(i) : e.wrapInner(i), n.create(e, a)) : n.remove(e),
				e.css("overflow", "")
			}
		}
		function An(e) {
		...
		function jn(t) {
			...
			return n.length || (n = e(k).eq(t - 1)),
			n
		}
		function Pn(e, t) {
			var n = t.find(z),
			i = n.find(O + '[data-anchor="' + e + '"]');
			return i.length || (i = n.find(O).eq(e)),
			i
		}
		function zn(e, t) {
			var n = jn(e);
			n.length && ("undefined" == typeof t && (t = 0), e === fi || n.hasClass(p) ? Hn(n, t) : Ut(n,
			function() {
				Hn(n, t)
			}))
		}
		...
		function Rn(e, t) {
			...
			n.find("li").first().find("a").addClass(p)
		}
		function Qn(e, t, n) {
			var i = "";
			r.anchors.length && !r.lockAnchors && (e ? ("undefined" != typeof n && (i = n), "undefined" == typeof t && (t = e), hi = t, qn(i + "/" + t)) : "undefined" != typeof e ? (hi = t, qn(n)) : qn(n)),
			Nn()
		}
		function qn(e) {
			if (r.recordHistory) location.hash = e;
			else if (vi || yi) t.history.replaceState(o, o, "#" + e);
			else {
		...
		function Nn() {
			...
			ui[0].className = ui[0].className.replace(a, ""),
			ui.addClass(h + "-" + s)
		}
		function Yn() {
		...
		function Gn() { (vi || yi) && (r.autoScrolling && ui.off(Ai.touchmove).on(Ai.touchmove, Pt), e(a).off(Ai.touchstart).on(Ai.touchstart, Qt).off(Ai.touchmove).on(Ai.touchmove, zt))
		}
		function Kn() { (vi || yi) && e(a).off(Ai.touchstart).off(Ai.touchmove)
		}
		function Jn() {
			var e;
		...
		function Zn(e) {
			...
			yi && Rt(e) && r.scrollBar && (t.y = e.touches[0].pageY, t.x = e.touches[0].pageX),
			t
		}
		function ei(e, t) {
			V(0, "internal"),
			"undefined" != typeof t && (bi = !0),
			Cn(e.closest(z), e),
			"undefined" != typeof t && (bi = !1),
			V(Bi.scrollingSpeed, "internal")
		}
		function ti(e) {
			var t = i.round(e);
		...
		function oi(t) {
			...
			clearTimeout(Di),
			clearTimeout($i),
			tt.off("scroll", Et).off("hashchange", rn).off("resize", wn),
			nt.off("click touchstart", D + " a").off("mouseenter", D + " li").off("mouseleave", D + " li").off("click touchstart", N).off("mouseover", r.normalScrollElements).off("mouseout", r.normalScrollElements),
			e(k).off("click touchstart", W),
			clearTimeout(Mi),
			clearTimeout(Ti),
			t && si()
		}
		function si() {
			ti(0),
			Ci.find("img[data-src], source[data-src], audio[data-src], iframe[data-src]").each(function() {
				Zt(e(this), "src")
			}),
			...
			e("html").removeClass(f),
			ui.removeClass(c),
			e.each(ui.get(0).className.split(/\s+/),
			function(e, t) {
				0 === t.indexOf(h) && ui.removeClass(t)
			}),
			e(k + ", " + O).each(function() {
				r.scrollOverflowHandler.remove(e(this)),
				e(this).removeClass(Q + " " + p)
			}),
			xn(Ci),
			Ci.find(L + ", " + R + ", " + z).each(function() {
		...
		yi = "ontouchstart" in t || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints,
		Ci = e(this),
		ki = tt.height(),
		bi = !1,
		Si = !0,
		...
		ri(),
		it.click = yi,
		it = e.extend(it, r.scrollOverflowOptions),
		e.extend(e.easing, {
	...
	var ot = {
		...
		create: function(t, n) {
			...
			i.each(function() {
				...
				n && e.each(ot.iScrollInstances,
				function() {
					e(this).destroy()
				}),
				n = new IScroll(t.get(0), it),
				ot.iScrollInstances.push(n),
				n.wheelOff(),
		...
		update: function(t, n) {
			clearTimeout(ot.refreshId),
			ot.refreshId = setTimeout(function() {
				e.each(ot.iScrollInstances,
				function() {
					e(this).get(0).refresh()
				})
			},
			150),
			t.find(l).css("height", n + "px").parent().css("height", n + "px")
		},
...
function(e) {
	e.fn.hover3d = function(t) {
		...
		return this.each(function() {
			function t() {
				a.addClass(n.hoverInClass + " " + n.hoverClass),
				currentX = currentY = 0,
				setTimeout(function() {
			...
			function i(e) {
				var t = a.innerWidth(),
				i = a.innerHeight(),
				o = Math.round(e.pageX - a.offset().left),
				s = Math.round(e.pageY - a.offset().top),
				l = n.invert ? (t / 2 - o) / n.sensitivity: -(t / 2 - o) / n.sensitivity,
				c = n.invert ? -(i / 2 - s) / n.sensitivity: (i / 2 - s) / n.sensitivity,
				u = o - t / 2,
				d = s - i / 2,
				f = Math.atan2(d, u),
				h = 180 * f / Math.PI - 90;
			...
			function o() {
				a.addClass(n.hoverOutClass + " " + n.hoverClass),
				a.css({
					perspective: n.perspective + "px",
					transformStyle: "preserve-3d",
				...
				setTimeout(function() {
					a.removeClass(n.hoverOutClass + " " + n.hoverClass),
					currentX = currentY = 0
				},
				1e3)
			}
			...
			currentX = 0,
			currentY = 0,
			n.shine && a.append('<div class="shine"></div>');
...
Base.prototype = {
	extend: function(e, t) {
		if (arguments.length > 1) {
			...
			a = ["constructor", "toString", "valueOf"], r = Base._prototyping ? 0 : 1; l = a[r++];) e[l] != s[l] && o.call(this, l, e[l]);
...
function(e) {
	...
	FlipClock = function(e, t, n) {
		return t instanceof Object && t instanceof Date == 0 && (n = t, t = 0),
...
function(e) {
	...
	FlipClock.Factory = FlipClock.Base.extend({
		...
		loadClockFace: function(e, t) {
			var n, i = "Face",
			o = !1;
			return e = e.ucfirst() + i,
			this.face.stop && (this.stop(), o = !0),
			this.$el.html(""),
			this.time.minimumDigits = this.minimumDigits,
			n = FlipClock[e] ? new FlipClock[e](this, t) : new FlipClock[this.defaultClockFace + i](this, t),
			n.build(),
			this.face = n,
			o && this.start(),
			this.face
		...
		loadLanguage: function(e) {
			var t;
			return t = FlipClock.Lang[e.ucfirst()] ? FlipClock.Lang[e.ucfirst()] : FlipClock.Lang[e] ? FlipClock.Lang[e] : FlipClock.Lang[this.defaultLanguage],
			this.lang = t
		},
...
function(e) {
	...
	FlipClock.Time = FlipClock.Base.extend({
		...
		getDayCounter: function(e) {
			...
			return e && t.push(this.getSeconds(!0)),
			this.digitize(t)
		},
		getDays: function(e) {
		...
		getMilitaryTime: function(e, t) {
			...
			return t === !0 && n.push(e.getSeconds()),
			this.digitize(n)
		},
		...
		getTimeSeconds: function(e) {
			return e || (e = new Date),
			this.time instanceof Date ? this.factory.countdown ? Math.max(this.time.getTime() / 1e3 - e.getTime() / 1e3, 0) : e.getTime() / 1e3 - this.time.getTime() / 1e3: this.time
		},
		getTime: function(e, t) {
			...
			return t === !0 && i.push(e.getSeconds()),
			this.digitize(i)
		},
		getSeconds: function(e) {
			var t = this.getTimeSeconds();
			return e && (60 == t ? t = 0 : t %= 60),
			Math.ceil(t)
		},
		getWeeks: function(e) {
	...
	FlipClock.CounterFace = FlipClock.Face.extend({
		...
		constructor: function(e, t) {
			...
			e.increment = function() {
				e.countdown = !1,
				e.setTime(e.getTime().getTimeSeconds() + 1)
			},
...
function(e) {
	FlipClock.DailyCounterFace = FlipClock.Face.extend({
		...
		build: function(t) {
			...
			this.showSeconds ? e(this.createDivider("Seconds")).insertBefore(this.lists[this.lists.length - 2].$el) : o = 2,
			e(this.createDivider("Minutes")).insertBefore(this.lists[this.lists.length - 4 + o].$el),
			e(this.createDivider("Hours")).insertBefore(this.lists[this.lists.length - 6 + o].$el),
...
function(e) {
	FlipClock.HourlyCounterFace = FlipClock.Face.extend({
		...
		build: function(t, n) {
			...
			n.length > o.length && e.each(n,
			function(e, t) {
				i.createList(t)
			}),
			e(this.createDivider("Seconds")).insertBefore(this.lists[this.lists.length - 2].$el),
			e(this.createDivider("Minutes")).insertBefore(this.lists[this.lists.length - 4].$el),
			t || e(this.createDivider("Hours", !0)).insertBefore(this.lists[0].$el),
			this.base()
		},
		flip: function(e, t) {
...
function() {
	FlipClock.MinuteCounterFace = FlipClock.HourlyCounterFace.extend({
		...
		flip: function(e, t) {
			e || (e = this.factory.time.getMinuteCounter()),
			this.base(e, t)
		}
	})
} (jQuery),
function(e) {
	FlipClock.TwelveHourClockFace = FlipClock.TwentyFourHourClockFace.extend({
		...
		flip: function(e, t) {
			this.meridiumText != this.getMeridium() && (this.meridiumText = this.getMeridium(), this.meridium.find("a").html(this.meridiumText)),
...
function() {
	...
	i = {
		request: function(e) {
			...
			/5\.1[.\d]* Safari/.test(navigator.userAgent) ? e[i]() : e[i](t && Element.ALLOW_KEYBOARD_INPUT)
		},
		exit: function() {
...
"undefined" != typeof NotifyMe && (NotifyMe.myAlert = function(e) {
	console.log(e),
	alert(0 === e.n ? "您已预约，不需要再次预约！": 1 === e.n ? "已成功预约UP2017直播，我们会在直播开始前通过QQ消息提醒您观看！": 2 === e.n ? "很抱歉，可能是系统繁忙，请稍后再试！": "可能不在活动时间，请稍后再试:" + e.n)
}),
$("#remindme").on("click",
function(e) {
	tryPgvSendClick({
		hottag: "a20170301pre.btn.remind"
	}),
	e.preventDefault(),
	doReg(23786)
});
...
adjustSize(),
/iPhone|iPad|iPod|Android/i.test(navigator.userAgent) ? (tryPgvSendClick({
	hottag: "a20170301pre.support.mobile"
}), ismobile = !0, $("body").addClass("mobile"), $(".loadingwrapper").hide(), setTimeout(function() {
	$(".loadingwrapper").show()
},
1e3), document.title = "UP2017腾讯互娱年度发布会") : tryPgvSendClick({
	hottag: "a20170301pre.support.notmobile"
}),
$("#fullpage .dot").prepend("<b></b>"),
$("#pop .pop-close").on("click",
function() {
	isnowpop = !1,
...
function() {
	...
	tryPgvSendClick({
		hottag: "a20170301pre.btn.dot" + e + t
	});
...
function() {
	tryPgvSendClick({
		hottag: "a20170301pre.page.loaded"
	})
}),
$("body").on("resloaded",
function() {
	...
	tryPgvSendClick({
		hottag: "a20170301pre.page.resloaded"
	});
...
function() {
	console.log("introed"),
	$(this).addClass("introed"),
	initFullpage(),
	tryPgvSendClick({
		hottag: "a20170301pre.page.introed"
	}),
	introed = !0,
	startStorm(),
	setTimeout(function() {
...
if ($(document).ready(function() {
	var e = new Date,
	t = new Date(2017, 3, 20, 10),
	n = t.getTime() / 1e3 - e.getTime() / 1e3;
	0 > n && (n = 0)
}), "undefined" != typeof Audio) {
	tryPgvSendClick({
		hottag: "a20170301pre.support.audio"
	});
	var mySound = new Audio("//game.gtimg.cn/images/up/act/a20170301pre/media/bg.mp3");
	mySound.loop = !0,
	mySound.play(),
	$(".btn-introbox").on("click",
	function() {
		mySound.play()
	}),
	$(".control .music").addClass("show").on("click",
	function() {
		mySound.paused ? (mySound.play(), $(this).removeClass("mute")) : (mySound.pause(), $(this).addClass("mute"))
	})
}
screenfull.enabled && (tryPgvSendClick({
	hottag: "a20170301pre.support.screenfull"
}), $(".control .fullsc").addClass("show").click(function() {
	screenfull.toggle(),
	$(this).toggleClass("enabled")
})),
supportWebGL ? (tryPgvSendClick(ismobile ? {
...
function() {}), $("body").addClass("webglyes")) : (tryPgvSendClick(ismobile ? {
	...
	hottag: "a20170301pre.support.pcwebglno"
}), toggleParticle = function() {},
$("body").addClass("webglno"), $("body").addClass("introed"), $("body").addClass("resloaded"), $("body").addClass("hideloading"), $(".chromeframe").addClass("show"), initFullpage(), tryPgvSendClick({
	hottag: "a20170301pre.page.introed"
}), introed = !0),
$(".skipintro").one(touchclick,
function() {
	skipIntrobox(),
...
function() {
	tryPgvSendClick({
		hottag: "a20170301pre.btn.qrcodeshow"
	}),
	toggleParticle(5),
	$("body").addClass("qring")
}).on("mouseleave",
function() {
	tryPgvSendClick({
		hottag: "a20170301pre.btn.qrcodehide"
	});
	var e = $("#fullpage .active").index("#fullpage .section"); (0 > e || e > 5) && (e = 0),
	toggleParticle(e),
